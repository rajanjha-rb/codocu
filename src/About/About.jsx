...
const containerVariants = {
  ...
  show: {
    ...
    y: 0,
    transition: {
      staggerChildren: 0.2, // shorter stagger between children
      ease: "easeOut",
      duration: 0.5, // faster overall container animation
    },
  },
};
...
const childVariants = {
  ...
  show: {
    opacity: 1,
    y: 0,
    transition: { duration: 0.4, ease: "easeOut" }, // faster child animations
  },
};
      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            aria-label="Learn more about Codocu"
          >
            Learn More
          </motion.button>
        </motion.div>
